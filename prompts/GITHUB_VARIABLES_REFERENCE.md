...
[ ] 2. Habilitar APIs: Cloud Run, Cloud Scheduler, Secret Manager,
       Artifact Registry, Cloud Storage, Sheets API
...
[ ] 13. Configurar webhook do Telegram:
        curl "https://api.telegram.org/bot{TOKEN}/setWebhook?url={CLOUD_RUN_URL}/webhook/telegram"
